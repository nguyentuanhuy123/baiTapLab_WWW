package iuh.fit.se.lab08_bai1_3_fe.controllers;
...
public class EmployeeController {
	...
	public ModelAndView save(@ModelAttribute Employee employee) {
		...
		if (employee.getId() == 0) {
			...
			response = employeeService.update(employee,employee.getId());
		}
	...
	@GetMapping("/search")
	public ModelAndView search(@RequestParam String kw, ModelAndView model) {
		ApiResponse response = employeeService.search(kw);
