...
<main>
    <form action="${pageContext.request.contextPath}/danhsach" method="get">
        <input type="text" name="kw" id="kw"
               placeholder="Tìm kiếm thông tin NCC theo MANCC hoặc TENNHACC hoặc DIACHI hoặc SODIENTHOAI">
    </form>
    ...
    <table>
        ...
        <c:forEach var="dt" items="${dts}">
            <tr>
                ...
                <th>
                    <form action="${pageContext.request.contextPath}/quanly" method="post" onclick="return(confirm('Ban Co Chac XOa Khong'))">
